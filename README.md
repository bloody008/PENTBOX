# La PENTBOX
## 🔍 À propos
Voici mon projet d'étude, une toolbox automatisée qui est conçue pour automatisée les tests d'intrusion. Développée en Python, elle permet de suivre la méthodologie des tests d'intrusion. La toolbox a été pensée de la manière suivante : 
...
- Les outils mentionnés dans les fichiers de commande [PhaseDeReconnaissance](PhasedeReconnaissance.txt), [ExploitPostExploit](ExploitPostExploit.txt), [PasswordAttack](PasswordAttack.txt) et [PasswordAnalysis](PasswordAnalysis.txt).
